...
namespace ExcelFilesCompiler.Interfaces
{
    public interface IDentalXRayStationService
    {
        ...
        Task AddAsync(DentalXRayStation model, string userId, string source, bool saveChanges = true);
        Task UpdateAsync(DentalXRayStation model, string userId, string source, bool saveChanges = true);
