...
namespace ExcelFilesCompiler.Interfaces
{
    public interface IDentalXRayStationService
    {
        ...
        Task AddAsync(DentalXRayStation model, string userName, bool saveChanges = true);
        Task UpdateAsync(DentalXRayStation model, string userName, bool saveChanges = true);
