namespace ExcelFilesCompiler.Models
{
    ...
    public class ContractDetails : GenericProperties
    {
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Contract ID cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Contract Agency cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Contract Service Branch cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Contract Client cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Contract Type cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Dawson Role On Contract cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Contract Status cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "KO Last Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "KO First Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "KO Phone cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "KO Phone 2 cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "KO Email cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "KO Notes cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "COR Last Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "COR First Name prefix cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "COR First Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "COR Rank cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "COR Phone cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "COR Phone 2 cannot be only white spaces.")]
        ...
        [EmailAddress(ErrorMessage = "Invalid Email Address.")]
        [RegularExpression(@"\S+", ErrorMessage = "COR Email cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "COR Notes cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Dawson Program Manager Last Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Dawson Program Manager First Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Dawson Deputy Program Manager Last Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Dawson Deputy Program Manager First Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Dawson Project Manager Last Name cannot be only white spaces.")]
        ...
        [RegularExpression(@"\S+", ErrorMessage = "Dawson Project Manager First Name cannot be only white spaces.")]
