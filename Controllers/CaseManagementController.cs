...
namespace ExcelFilesCompiler.Controllers
{
    ...
    public class CaseManagementController : Controller
    {
        ...
        public CaseManagementController(ILogger<ImmunizationStationController> logger, IConfiguration configuration, UserManager<ApplicationUser> userManager, IContainerMonitoringService service)
        {
            _logger = logger;
