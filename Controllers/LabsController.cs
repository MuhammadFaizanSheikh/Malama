...
namespace ExcelFilesCompiler.Controllers
{
    ...
    public class LabsController : Controller
    {
        ...
        public LabsController(ILogger<ImmunizationStationController> logger, IConfiguration configuration, UserManager<ApplicationUser> userManager, IContainerMonitoringService service)
        {
            _logger = logger;
