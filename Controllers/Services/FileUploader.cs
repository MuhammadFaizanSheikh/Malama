    ...
    public class FileUploader : IFileUploader
    {
                ...
                var dto = new PostEventLabStationAnalysisDto
                {
                    ...
                    PostEventLabStation = entity.PostEventLabStation != null
                        ? new PostEventLabStationDto
                        {
                            ...
                            G6pdResultMalamaUploadedOriginalFileName = entity.PostEventLabStation.G6pdResultMalamaUploadedOriginalFileName,
                            ...
                            // LipidPanel
                            LipidPanelResultReceived = entity.PostEventLabStation.LipidPanelResultReceived,
                            LipidPanelResultReason = entity.PostEventLabStation.LipidPanelResultReason,
                            LipidPanelResultReceivedDateTime = entity.PostEventLabStation.LipidPanelResultReceivedDateTime,
                            ...
                            LipidPanelResultMalamaUploadedOriginalFileName = entity.PostEventLabStation.LipidPanelResultMalamaUploadedOriginalFileName,
                            ...
                            AboResultMalamaUploadedOriginalFileName = entity.PostEventLabStation.AboResultMalamaUploadedOriginalFileName,
                            ...
                            HivResultMalamaUploadedOriginalFileName = entity.PostEventLabStation.HivResultMalamaUploadedOriginalFileName,
                            ...
                            PregnancyResultMalamaUploadedOriginalFileName = entity.PostEventLabStation.PregnancyResultMalamaUploadedOriginalFileName,
                            ...
                            SickleCellResultMalamaUploadedOriginalFileName = entity.PostEventLabStation.SickleCellResultMalamaUploadedOriginalFileName,
        ...
        public async Task<ResponseDto> UpdateSingleRecordAsync(FileDataDto dto, string updatedBy)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = Messages.DataUpdateFailed,
                    Data = null
                };
            }
        }
