...
namespace ExcelFilesCompiler.Controllers
{
    ...
    public class SelfAssessmentController : Controller
    {
        ...
        public SelfAssessmentController(ILogger<ImmunizationStationController> logger, IConfiguration configuration, UserManager<ApplicationUser> userManager, IContainerMonitoringService service)
        {
            _logger = logger;
