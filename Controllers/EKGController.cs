...
namespace ExcelFilesCompiler.Controllers
{
    ...
    public class EKGController : Controller
    {
        ...
        public EKGController(ILogger<ImmunizationStationController> logger, IConfiguration configuration, UserManager<ApplicationUser> userManager, IContainerMonitoringService service)
        {
            _logger = logger;
