...
namespace ExcelFilesCompiler.Controllers
{
    ...
    public class DentalXRayController : Controller
    {
        ...
        public DentalXRayController(ILogger<ImmunizationStationController> logger, IConfiguration configuration, UserManager<ApplicationUser> userManager, IContainerMonitoringService service)
        {
            _logger = logger;
