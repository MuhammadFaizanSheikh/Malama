...
namespace ExcelFilesCompiler.Controllers
{
    ...
    public class DentalExamsController : Controller
    {
        ...
        public DentalExamsController(ILogger<ImmunizationStationController> logger, IConfiguration configuration, UserManager<ApplicationUser> userManager, IContainerMonitoringService service)
        {
            _logger = logger;
