...
namespace ExcelFilesCompiler.Controllers
{
    ...
    public class DentalTreatmentController : Controller
    {
        ...
        public DentalTreatmentController(ILogger<ImmunizationStationController> logger, IConfiguration configuration, UserManager<ApplicationUser> userManager, IContainerMonitoringService service)
        {
            _logger = logger;
